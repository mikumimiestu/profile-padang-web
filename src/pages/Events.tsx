...
import { Calendar, ChevronRight, Star, MapPin, Clock, Users } from 'lucide-react';

const Events = () => {
  useEffect(() => {
    document.title = 'Events Kota Padang - Agenda Kegiatan & Festival di Kota Padang';
  }, []);
  ...
  const upcomingEvents = [
    {
      ...
      description: "Festival budaya Minangkabau untuk memperingati wafatnya cucu Nabi Muhammad SAW",
    ...
    },
    {
      ...
      description: "Balap sepeda internasional melintasi pemandangan indah Sumatera Barat",
    ...
    },
    {
      ...
      description: "Perayaan sastra dan budaya mengangkat karya Marah Rusli",
    ...
    {
      name: "Pesta Pantai Padang",
      description: "Kegiatan olahraga pantai, musik, dan kuliner sepanjang pesisir",
      location: "Pantai Padang",
      date: "Desember",
        ...
        <div className="container mx-auto relative z-10">
          ...
          >
            ...
            <p className="text-xl text-white/90 max-w-3xl mx-auto">
              Jadwal lengkap festival, pertunjukan, dan kegiatan menarik di Kota Padang
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 container mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Jelajahi berbagai acara menarik yang akan diselenggarakan di Kota Padang
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="text-3xl font-bold text-gray-800 mb-6">
                Keistimewaan <span className="text-blue-600">Festival</span> di Kota Padang
              </h3>
            ...
            <div className="relative h-full min-h-[300px] rounded-xl overflow-hidden shadow-lg">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/40 to-transparent flex items-end p-6">
                <p className="text-white/90">Festival Tabuik - salah satu tradisi budaya terbesar di Padang</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {eventCategories.map((category, index) => (
              ...
              >
                ...
                <p className="text-blue-600 font-medium">{category.count}+ Events</p>
              </motion.div>
            ))}
          </div>
        </div>
                ...
                {eventVenues.map((venue, i) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <h4 className="font-medium group-hover:text-blue-600 transition-colors">{venue.name}</h4>
                      <p className="text-sm text-gray-500">{venue.location}</p>
                      <p className="text-xs text-blue-600 mt-1">{venue.capacity}</p>
                    </div>
        ...
        <div className="text-center">
          <h3 className="text-2xl font-bold text-gray-800 mb-4">
            Siap Menghadiri <span className="text-blue-600">Event di Kota Padang</span>?
          </h3>
          <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
            Temukan kemeriahan festival dan acara menarik yang memperkenalkan budaya Minangkabau
          </p>
          <motion.button
